...
**Excel & Spreadsheet Processing (11 MCP tools)**

## Overview

PyStreamXL is part of the unified **MCP 2.0 Mega-Platform** (207 tools across 18 projects). This project provides AI-native tools via Model Context Protocol (MCP 2.0).

## Features

- **MCP 2.0 Support**: Discoverable via MCP protocol protocol on port 8781
...
```bash
pip install --only-binary=:all: PyStreamXL
```

## MCP 2.0 Integration

Enable MCP tools on port **8781** (see MCP_QUICKSTART.md for details).
...
See [MCP_QUICKSTART.md](PyStreamXL/MCP_QUICKSTART.md) for detailed tool documentation.
